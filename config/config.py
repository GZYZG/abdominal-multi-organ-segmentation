...
parser.add_argument('--batch_size', type=int, default=3, help='batch size while training')
...
model_name = "net1209-0.978-0.858.pth"
...
parser.add_argument('--slice_num', type=int, default=16, help='Selected num of slices in a CT')
